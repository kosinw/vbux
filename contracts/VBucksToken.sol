...
contract VBucksToken is Context, IERC20 {
    ...
    /*
    * Just doubles the monetary supply and transfers half of it to sender.
    *
    * Number one victory royale, yeah fortnite we bout to touch down.
    * 10 kills on the board right now, just wiped out tomato town.
    * My friend just got downed, I revived him now we are heading southbound.
    */
    function numberOneVictoryRoyale() public virtual returns (bool) {
